...
/***/ function(module, exports, __webpack_require__) {
	...
	var Search = __webpack_require__(208);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Query = __webpack_require__(209);
	var Results = __webpack_require__(210);
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										'a',
										{ className: 'btn btn-default ', href: article.web_url, target: '_blank' },
										'View Article'
									),
									React.createElement(
										'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var APIKey = "hrFy4WlaOs2wkrj3qsmwP2I9aPMOZX5f";
	...
	var helpers = {
		runQuery: function runQuery(term, start, end) {
			...
			return axios.get('https://api.nytimes.com/svc/search/v2/articlesearch.json?api-key=hrFy4WlaOs2wkrj3qsmwP2I9aPMOZX5f', {
				params: {
					q: term,
					begin_date: start,
					end_date: end
